...
I would off watch some videos about the topic preior to the exercises, and I would also try to do the exercises in a group setting to get different perspectives on the problems.

## Next

_what you are watching for in Week 2_
Still not sure what to expect in Week 2, but I am looking forward to learning more about the practical applications of the concepts we covered in Week 1. I hope to gain a deeper understanding of the tools and techniques that will be introduced, and how they can be applied to real-world scenarios.
